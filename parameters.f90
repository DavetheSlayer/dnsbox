...
!***************************************************************************
    ...
    integer(kind=4), parameter      :: Nt = 100 ! 100000       ! Number of t-steps
    integer(kind=4), parameter      :: iSaveRate1 = 50 ! 1000 ! save rate for state files
    integer(kind=4), parameter      :: iSaveRate2 = 10 ! 100  ! save rate for analysis files
