...
!***************************************************************************
    ...
    integer(kind=4), parameter      :: Nx = 32 ! 64! 256
    integer(kind=4), parameter      :: Ny = 32 ! 64! 256
    integer(kind=4), parameter      :: Nz = 32 ! 64! 256
    ...
    real(kind=8), parameter         :: nu = 0.07 ! 4.491d-3 ! 0.2d0      ! Kinematic viscosity 
    real(kind=8), parameter         :: Q = 0.0 ! 0.0667d0 ! 0.5d0       ! Forcing multiplier
