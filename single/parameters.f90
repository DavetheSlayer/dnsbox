...
!***************************************************************************
    ...
    integer(kind=4), parameter      :: iSaveRate1 = 50   ! save rate for state files
    ...
    real(kind=8), parameter         :: nu = 0.07d0       ! Kinematic viscosity 
    ...
    real(kind=8), parameter         :: Pin = 0.0d0 ! 0.1d0       ! Power input-rate
